...
const KNOWN_COORDS: Record<string, { lat: number; lng: number }> = {
  "Augusta National": { lat: 33.503, lng: -82.022 },
  "Pebble Beach": { lat: 36.567, lng: -121.948 },
  "TPC Sawgrass": { lat: 30.198, lng: -81.394 },
  "Pinehurst No. 2": { lat: 35.193, lng: -79.469 },
  "Bethpage Black": { lat: 40.745, lng: -73.456 },
  "Torrey Pines South": { lat: 32.900, lng: -117.252 },
  "Whistling Straits": { lat: 43.844, lng: -87.732 },
  ...
  "Cypress Point": { lat: 36.581, lng: -121.965 },
  "Shinnecock Hills": { lat: 40.891, lng: -72.442 },
  "Merion Golf Club": { lat: 40.005, lng: -75.312 },
  "Streamsong Red": { lat: 27.628, lng: -81.553 },
  "Cabot Cliffs": { lat: 46.214, lng: -61.449 },
  "Sand Valley": { lat: 44.091, lng: -89.871 },
  "Winged Foot": { lat: 41.058, lng: -73.788 },
  "Chambers Bay": { lat: 47.200, lng: -122.570 },
  "St Andrews": { lat: 56.344, lng: -2.804 },
  "Gaylord Springs": { lat: 36.186, lng: -86.625 },
  "Hermitage Golf Course": { lat: 36.296, lng: -86.601 },
  "Nashville Golf & Athletic Club": { lat: 36.097, lng: -86.660 },
  "Harpeth Hills": { lat: 36.070, lng: -86.868 },
  ...
  "Indian Hills Golf Course": { lat: 35.858, lng: -86.418 },
  "Twelve Stones Crossing": { lat: 35.836, lng: -86.410 },
  "Windtree Golf Course": { lat: 36.195, lng: -86.515 },
  "Pine Creek Golf Course": { lat: 36.180, lng: -86.510 },
  "Eagles Landing": { lat: 36.202, lng: -86.342 },
  ...
  "Walker Course at Clemson": { lat: 34.678, lng: -82.832 },
