...
IMPORTANT: For "estimatedLaunchData", estimate realistic values based on the swing mechanics you observe, the club type, and typical amateur golfer data. These are AI-estimated values meant to give the golfer a sense of their likely ball flight characteristics.`
  ...
  app.post("/api/seed", async (_req: Request, res: Response) => {
    ...
    const sampleCourses = [
      ...
      },
      {
        ...
        yearBuilt: 1969,
        description: "Harbour Town Golf Links is a Lowcountry cathedral — a place where ancient live oaks draped in Spanish moss form canopied corridors that lead you from tee to green like the aisles of some grand, open-air chapel. Pete Dye and a young Jack Nicklaus collaborated on a design that defied the era's obsession with length, instead demanding precision, creativity, and nerve. The fairways are tight, the greens are small and fiercely contoured, and the signature 18th hole — a slight dogleg left along the Calibogue Sound to the candy-striped lighthouse — is one of the most iconic finishing holes in professional golf. Home to the RBC Heritage since 1969, Harbour Town rewards the thinking golfer. Afternoon light on the Sound turns the marsh grass to burnished copper, and the salt air carries the rhythmic pulse of the Atlantic. It is, quite simply, one of those places where the game feels exactly right.",
        amenities: "Pro Shop, Heritage Grill, Sea Pines Resort, Practice Facility, Caddie Service, Lighthouse, Marina, Golf Academy",
        phone: "(843) 363-4485",
        website: "https://www.seapines.com/golf/harbour-town-golf-links",
        imageUrl: "/course-images/golf_links_1.jpg",
        galleryImages: ["/course-images/golf_morning_3.jpg", "/course-images/golf_aerial_1.jpg"],
      },
      {
        name: "Caledonia Golf & Fish Club",
        location: "369 Caledonia Dr",
        city: "Pawleys Island",
        state: "SC",
        holes: 18,
        par: 70,
        ...
        yearBuilt: 1994,
        description: "You arrive at Caledonia down an avenue of three-hundred-year-old live oaks, and from that first moment the course announces itself as something apart. Mike Strantz — the visionary artist-architect who left us far too soon — sculpted Caledonia from a former rice plantation on the banks of the Waccamaw River, and every hole feels as though it has existed in this landscape for centuries. The routing flows through ancient maritime forest, across tidal marshland, and along the edges of spring-fed lagoons where herons stand motionless in the shallows. Strantz's greens are bold, flowing compositions that reward imagination and penalize autopilot. The par-3 11th, played across a wide marsh to a green tucked against a curtain of live oaks, may be the most beautiful one-shot hole on the East Coast. Caledonia consistently ranks among the top public-access courses in America, and for anyone who has stood on that first tee beneath the oaks, the reason is self-evident. This is not just a golf course. It is a place that stays with you.",
        amenities: "Pro Shop, Plantation Clubhouse, Southern-Style Dining, Practice Range, Short Game Area, Caddie Program",
        phone: "(843) 237-3675",
        website: "https://www.caledoniagolfandfishclub.com",
        imageUrl: "/course-images/golf_courses_4.jpg",
        galleryImages: ["/course-images/golf_green_3.jpg", "/course-images/golf_morning_4.jpg"],
      },
      {
        name: "Pawleys Plantation Golf & Country Club",
        location: "70 Tanglewood Dr",
        city: "Pawleys Island",
        state: "SC",
        holes: 18,
        par: 72,
        ...
        yearBuilt: 1988,
        description: "Jack Nicklaus carved Pawleys Plantation from the marshy edges of the Waccamaw Neck, and the result is a course that feels both grand and intimate — wide fairways that encourage aggressive play off the tee, paired with approach shots that demand absolute precision. The front nine winds through salt marsh and maritime forest, with several holes playing along or across tidal creeks where fiddler crabs scatter at the sound of your footsteps. The back nine opens up to broader views of the marsh, culminating in a dramatic finishing stretch where the Waccamaw River shimmers in the distance. Nicklaus signature mounding frames the landing areas and greens complexes, creating visual drama and strategic options on nearly every hole. The marsh views from the elevated 13th tee — where the grass stretches to the horizon in waves of green and gold — belong in a gallery. Pawleys Plantation delivers a Nicklaus Signature experience without the pretension, and at a price point that makes it one of the best values on the Grand Strand.",
        amenities: "Pro Shop, Clubhouse Restaurant, Driving Range, Putting Green, Chipping Area, Pool, Tennis Courts",
        phone: "(843) 237-6100",
        website: "https://www.pawleysplantation.com",
        imageUrl: "/course-images/golf_courses_5.jpg",
        galleryImages: ["/course-images/golf_aerial_4.jpg", "/course-images/golf_links_3.jpg"],
      },
      {
        name: "Wild Dunes Resort - Links Course",
        location: "5757 Palm Blvd",
        city: "Isle of Palms",
        state: "SC",
        holes: 18,
        par: 72,
        ...
        designer: "Tom Fazio",
        yearBuilt: 1980,
        description: "The Links Course at Wild Dunes occupies a slender barrier island northeast of Charleston, where the Intracoastal Waterway meets the open Atlantic. Tom Fazio routed the course through maritime forest, past tidal lagoons, and along the ocean's edge — the last two holes play directly along the beach, with the sound of the surf as your only gallery. The 17th is a narrow par-5 that hugs the dunes, and the 18th green sits so close to the high-tide line that salt spray occasionally drifts across the putting surface. Hurricane Hugo reshaped several oceanside holes in 1989, and Fazio's redesign leaned into the drama, creating a finishing sequence that rivals any resort course in the Southeast. The wind is ever-present — a variable that transforms the course daily from playable to punishing. Palmetto palms rustle overhead, dolphins arc through the channel beyond the 15th green, and the golden-hour light on the marsh makes the drive back across the bridge feel like leaving a dream. Wild Dunes is Charleston golf at its most elemental.",
        amenities: "Pro Shop, Resort Hotel, Boardwalk Grill, Beach Club, Pool, Tennis, Practice Facility, Bike Rentals",
        phone: "(843) 886-2164",
        website: "https://www.wilddunes.com/golf",
        imageUrl: "/course-images/golf_links_4.jpg",
        galleryImages: ["/course-images/golf_morning_5.jpg", "/course-images/golf_green_4.jpg"],
      },
      {
        ...
        greenFee: 125,
        courseType: "Resort",
        designer: "Donald Ross (redesigned by Kris Spence)",
        yearBuilt: 1926,
        description: "Golf at the Grove Park Inn is mountain golf the way it was meant to be — a Donald Ross original draped across the western slopes of Sunset Mountain, with the Blue Ridge folding away to the horizon in every direction. Ross routed the course in 1926 to take full advantage of the dramatic elevation changes, and a sympathetic 2001 renovation by Kris Spence restored many of his original green complexes while modernizing the infrastructure. The course drops, climbs, and sidehills through hardwood forest — sugar maples, red oaks, and tulip poplars that explode into color every October, turning a round of golf into a walk through a living painting. From the elevated 7th tee, the skyline of downtown Asheville is visible through a gap in the trees, and on clear mornings the Great Smoky Mountains float on the western horizon like a blue watercolor wash. The greens are small, sloped, and full of Ross's characteristic subtlety. The course is not long, but it punishes lazy thinking. After your round, the iconic stone lodge — built in 1913 by stonemasons and still one of the most beautiful resort properties in America — awaits with a fireplace, a bourbon, and that view.",
        amenities: "Pro Shop, Resort Hotel, Spa, Edison Restaurant, Sunset Terrace, Pool, Tennis, Golf Academy, Subterranean Pool & Waterfall",
        phone: "(828) 252-2711",
        website: "https://www.omnihotels.com/hotels/asheville-grove-park",
        imageUrl: "/course-images/golf_morning_6.jpg",
        galleryImages: ["/course-images/golf_aerial_5.jpg", "/course-images/golf_green_5.jpg"],
      },
      {
        name: "Sequoyah National Golf Club",
        location: "79 Cahons Rd",
        city: "Whittier",
        state: "NC",
        holes: 18,
        par: 72,
        ...
        yearBuilt: 2009,
        description: "Deep in the Great Smoky Mountains, on land belonging to the Eastern Band of Cherokee Indians, Sequoyah National unfolds through a valley so beautiful it feels like trespassing on something sacred. Robert Trent Jones II designed the course to honor the terrain rather than dominate it — fairways follow the natural contours of the Oconaluftee River valley, greens sit in natural bowls framed by ancient hardwoods, and the Smoky Mountain ridgelines provide a backdrop that no architect could improve upon. The course is named for Sequoyah, the Cherokee scholar who created the Cherokee syllabary, and the connection to the land runs deep. Elevation changes are significant but never gimmicky — the par-3 4th drops over a hundred feet from tee to green, with a mountain stream guarding the front edge and mist rising from the water on cool mornings. The conditioning is exceptional for a mountain course, the price is remarkably fair, and the experience of playing golf surrounded by peaks that top 6,000 feet is unlike anything else east of the Rockies. If you play one course in Western North Carolina that isn't on a resort property, make it this one.",
        amenities: "Pro Shop, Grille Room, Covered Patio, Practice Range, Putting Green, Short Game Area, Cherokee Cultural Center Nearby",
        phone: "(828) 497-3000",
        website: "https://www.sequoyahnational.com",
        imageUrl: "/course-images/golf_courses_6.jpg",
        galleryImages: ["/course-images/golf_morning_7.jpg", "/course-images/golf_aerial_6.jpg"],
      },
      {
        name: "Cleghorn Golf & Sports Club",
        location: "185 Golf Circle",
        city: "Rutherfordton",
        state: "NC",
        holes: 18,
        par: 72,
        ...
        yearBuilt: 1999,
        description: "Cleghorn sits in the Blue Ridge foothills between Asheville and Charlotte, and it plays like a course that costs three times the green fee. George Cobb routed the layout through rolling terrain studded with mature hardwoods and punctuated by rock outcroppings, natural streams, and long views of the surrounding mountains. The signature hole is the par-3 7th — a dramatic downhill shot to a green perched on a peninsula jutting into a spring-fed lake, with the Blue Ridge visible beyond. It's the kind of hole you photograph and remember. The course is immaculately conditioned, the bent-grass greens are fast and true, and the combination of mountain scenery, strategic design, and value pricing makes Cleghorn one of the best-kept secrets in the Carolinas. The clubhouse sits on a hilltop with panoramic views of the Broad River valley, and the post-round burger on the patio — with the mountains going purple in the late-afternoon light — is as good as any clubhouse experience in the Southeast. Bring your camera.",
        amenities: "Pro Shop, Grille Room, Covered Patio, Practice Range, Putting Green, Swimming Pool, Tennis Courts",
        phone: "(828) 286-9117",
        website: "https://www.cleghorngolf.com",
        imageUrl: "/course-images/golf_green_6.jpg",
        galleryImages: ["/course-images/golf_club_5.jpg", "/course-images/golf_links_5.jpg"],
      },
      {
        name: "East Lake Golf Club",
        location: "2575 Alston Dr SE",
        city: "Atlanta",
        state: "GA",
        holes: 18,
        par: 72,
        ...
        greenFee: 250,
        courseType: "Private",
        designer: "Donald Ross (restored by Rees Jones)",
        yearBuilt: 1908,
        description: "East Lake is where Bobby Jones learned to play golf, and that fact alone makes it hallowed ground — but the story of East Lake is bigger than any one player. The course sits in a neighborhood that nearly collapsed in the 1960s and 70s, and its resurrection — led by developer Tom Cousins and the East Lake Foundation — is one of the great urban renewal stories in America. The golf course, restored to Donald Ross's original vision by Rees Jones in 1994, is a stern, strategic test that hosts the TOUR Championship each September, the finale of the FedEx Cup Playoffs. The layout wraps around East Lake itself, a spring-fed body of water that gives the property its name and character. Ross's crowned greens demand precision, and the tree-lined fairways punish wayward drives without mercy. Standing on the first tee, you feel the weight of history — Jones, Hagen, Sarazen, and now the best players in the modern game have all walked these fairways. The clubhouse, rebuilt in 1928, houses Jones memorabilia and photographs that connect every member and guest to more than a century of American golf history. East Lake is not just a golf course. It is a monument.",
        amenities: "Pro Shop, Historic Clubhouse, Bobby Jones Museum, Practice Range, Pool, Tennis, Dining Room, Men's Grill",
        phone: "(404) 373-5722",
        website: "https://www.eastlakegolfclub.com",
        imageUrl: "/course-images/golf_courses_7.jpg",
        galleryImages: ["/course-images/golf_aerial_7.jpg", "/course-images/golf_green_7.jpg"],
      },
      {
        name: "Chateau Elan Golf Club - Woodlands Course",
        location: "6060 Golf Club Dr",
        city: "Braselton",
        state: "GA",
        holes: 18,
        par: 72,
        ...
        designer: "Denis Griffiths",
        yearBuilt: 1989,
        description: "Forty-five minutes north of Atlanta, Château Élan occupies a rolling estate that could pass for the French countryside — vineyards, stone walls, and a winery that produces actual wine surround three championship golf courses. The Woodlands Course, designed by Denis Griffiths, is the crown jewel: a mature, tree-lined layout that winds through the estate's forests and across its creeks with the quiet confidence of a course that knows it doesn't need to shout. The fairways are generous enough to keep the round moving, but the greens are sharply contoured and protected by deep bunkers that demand accurate approaches. The par-4 8th is a standout — a sweeping dogleg right around a lake, with the château visible on the hill above, looking for all the world like you've been teleported to Provence. The resort experience elevates the golf: after your round, there's a spa, a winery tasting room, and restaurants that take the phrase 'resort dining' seriously. For Atlanta golfers looking for an escape without the drive to the coast or the mountains, Château Élan delivers European elegance in a Georgia setting.",
        amenities: "Pro Shop, Winery & Vineyard, Spa, 7 Restaurants, Resort Hotel, Pool, Tennis, Fitness Center, Equestrian Center",
        phone: "(678) 425-0900",
        website: "https://www.chateauelan.com",
        imageUrl: "/course-images/golf_morning_10.jpg",
        galleryImages: ["/course-images/golf_club_6.jpg", "/course-images/golf_courses_8.jpg"],
      },
      {
        name: "Barnsley Resort Golf Course",
        location: "597 Barnsley Gardens Rd",
        city: "Adairsville",
        state: "GA",
        holes: 18,
        par: 72,
        ...
        designer: "Jim Fazio",
        yearBuilt: 1999,
        description: "Barnsley Resort occupies 3,300 acres of rolling North Georgia countryside an hour north of Atlanta, and the golf course — designed by Jim Fazio — moves through this landscape with the unhurried grace of a long afternoon in the foothills. The property was once a 19th-century cotton plantation, and the ruins of the original Woodlands manor house still stand among the boxwood gardens, giving the resort a sense of deep-rooted Southern history. The course itself plays through hardwood forest and across meadows, with natural streams and ponds woven into the design. Elevation changes are constant but gentle — the kind of rolling terrain that reveals new views with each hole. The par-3 15th plays downhill to a green backed by a stone wall and framed by enormous white oaks, and in October, when the hardwoods turn, it looks like something from a Hudson River School painting. Fazio's routing never forces drama — it finds it in the land. The resort offers shooting sports, horseback riding, and a spa, making Barnsley a full weekend destination. But it's the golf course — quiet, beautiful, and honest — that brings people back.",
        amenities: "Pro Shop, Rice House Restaurant, Beer Garden, Resort Cottages, Spa, Shooting & Hunting, Horseback Riding, Pool, Fitness Center",
        phone: "(770) 773-7480",
        website: "https://www.barnsleyresort.com",
        imageUrl: "/course-images/golf_links_6.jpg",
        galleryImages: ["/course-images/golf_morning_8.jpg", "/course-images/golf_aerial_8.jpg"],
      },
    ];
  ...
  app.get("/api/bomber/profile/:userId", async (req: Request, res: Response) => {
    try {
      ...
      if (!profile) {
        profile = await storage.createBomberProfile(userId);
  ...
  app.post("/api/bomber/drive", async (req: Request, res: Response) => {
    try {
      ...
      const xpBase = 10;
      const xpBonus = inBounds ? Math.max(0, Math.floor((distance - 200) / 10)) : 0;
      const xpEarned = xpBase + xpBonus;

      const coinsBase = 5;
      const coinsBonus = inBounds && distance > 250 ? Math.floor((distance - 250) / 10) : 0;
      const coinsEarned = coinsBase + coinsBonus;

      const newXp = profile.xp + xpEarned;
      const newCoins = profile.coins + coinsEarned;
      const newTotalDrives = profile.totalDrives + 1;
      const newBest = inBounds && distance > profile.bestDistance ? distance : profile.bestDistance;

      const { getDivision, getChestTypeForDistance } = await import("@shared/bomber-data");
      const division = getDivision(newXp);

      const updateData: any = {
        xp: newXp,
        coins: newCoins,
        totalDrives: newTotalDrives,
        bestDistance: newBest,
        division: division.id,
      };

      const updated = await storage.updateBomberProfile(userId, updateData);

      if (inBounds && distance > 0) {
        await storage.addBomberLeaderboardEntry({
          userId,
      ...
      if (newTotalDrives % 5 === 0 && inBounds) {
        const chestType = getChestTypeForDistance(distance);
        chestEarned = await storage.addBomberChest(userId, chestType);
      }
      ...
      res.json({
        ...
        levelInfo,
        division,
        newBest: distance === newBest && inBounds,
      });
    } catch (e: any) {
      res.status(500).json({ error: e.message });
    }
  ...
  app.get("/api/bomber/leaderboard", async (_req: Request, res: Response) => {
    try {
  ...
  app.post("/api/bomber/daily-reward/:userId", async (req: Request, res: Response) => {
    try {
      const { userId } = req.params;
      let profile = await storage.getBomberProfile(userId);
      if (!profile) profile = await storage.createBomberProfile(userId);
  ...
  app.post("/api/bomber/chest/:id/open", async (req: Request, res: Response) => {
    try {
      const id = parseInt(req.params.id);
      ...
      const opened = await storage.openBomberChest(id, contents);
      ...
      if (profile) {
        ...
        const newXp = profile.xp + contents.xp;
        const newGems = profile.gems + contents.gems;
        await storage.updateBomberProfile(userId, { coins: newCoins, xp: newXp, gems: newGems });
      }
  ...
  app.get("/api/bomber/challenges/today", async (_req: Request, res: Response) => {
    try {
      const today = new Date().toISOString().split("T")[0];
      let challenge = await storage.getDailyChallenge(today);
      if (!challenge) {
        const { DAILY_CHALLENGE_TEMPLATES } = await import("@shared/bomber-data");
  ...
  app.get("/api/bomber/equipment/:userId", async (req: Request, res: Response) => {
    try {
      const equipment = await storage.getBomberEquipment(req.params.userId);
      res.json(equipment);
    } catch (e: any) {
      res.status(500).json({ error: e.message });
    }
  ...
  app.post("/api/bomber/equipment/:id/upgrade", async (req: Request, res: Response) => {
    try {
      const id = parseInt(req.params.id);
      const equipment = await storage.getBomberEquipment(req.body.userId);
      const item = equipment.find(e => e.id === id);
      if (!item) return res.status(404).json({ error: "Equipment not found" });

      const { getEquipmentDef } = await import("@shared/bomber-data");
      const def = getEquipmentDef(item.equipmentId, item.type as "driver" | "ball");
      if (!def) return res.status(400).json({ error: "Unknown equipment" });

      if (item.duplicates < def.dupesToUpgrade) {
        return res.status(400).json({ error: `Need ${def.dupesToUpgrade} duplicates to upgrade, have ${item.duplicates}` });
      }

      const upgraded = await storage.upgradeBomberEquipment(id);
      res.json(upgraded);
    } catch (e: any) {
      res.status(500).json({ error: e.message });
    }
  ...
  app.post("/api/bomber/equip", async (req: Request, res: Response) => {
    try {
      const { userId, equipmentId, type } = req.body;
      if (!userId || !equipmentId || !type) return res.status(400).json({ error: "Missing fields" });

      const equipment = await storage.getBomberEquipment(userId);
      const owned = equipment.find(e => e.equipmentId === equipmentId && e.type === type);
      if (!owned) return res.status(400).json({ error: "Equipment not owned" });

      const updateData: any = {};
      if (type === "driver") updateData.equippedDriver = equipmentId;
      if (type === "ball") updateData.equippedBall = equipmentId;
